...
[← Back to Documentation](/docs)`;
  ...
  for (const section of toc) {
    const found = section.children.find(child => child.path === props.url.pathname);
    if (found) {
          ...
          <div class="border-b border-surface0 bg-mantle/50 backdrop-blur-sm sticky top-1 z-10">
            <div class="p-4 md:p-6">
              <nav class="flex items-center space-x-2 text-sm text-subtext1">
                <a href="/docs" class="hover:text-text transition-colors">Documentation</a>
                <span>›</span>
        ...
        <div class="flex">
          ...
          <aside class="hidden xl:block w-64 shrink-0">
            <div class="sticky top-24 p-6">
              {headings.length > 1 && (
                <div class="space-y-4">
                  <h3 class="text-sm font-semibold text-text uppercase tracking-wider">On this page</h3>
                  <nav class="space-y-2">
              ...
              <div class="mt-8 pt-6 border-t border-surface0">
                <h3 class="text-sm font-semibold text-text uppercase tracking-wider mb-3">Helpful Links</h3>
                <nav class="space-y-2 text-sm">
                  <a href="https://github.com/tryandromeda/andromeda" class="block text-subtext1 hover:text-text transition-colors">
                    GitHub Repository
                  </a>
                  <a href="https://discord.gg/tgjAnX2Ny3" class="block text-subtext1 hover:text-text transition-colors">
                    Discord Community
                  </a>
                  <a href="/docs/faq" class="block text-subtext1 hover:text-text transition-colors">
                    FAQ
                  </a>
                </nav>
              </div>
