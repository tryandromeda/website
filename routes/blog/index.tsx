      ...
      <main class="pt-20 pb-20">
        <div class="container mx-auto px-6 max-w-7xl">
          ...
          <header class="relative text-center mb-20 py-16">
            <div class="absolute inset-0 bg-gradient-to-br from-blue/5 via-transparent to-mauve/5 rounded-3xl"></div>
                ...
                {posts.map((post, index) => (
                  <article
                    ...
                    class={`group relative bg-gradient-to-br from-surface0/30 to-surface0/10 backdrop-blur-sm rounded-3xl overflow-hidden border border-surface1/30 hover:border-blue/20 transition-all duration-500 hover:shadow-2xl hover:shadow-blue/5 ${
                      index === 0 ? "lg:grid lg:grid-cols-2 lg:gap-0 lg:min-h-[500px]" : ""
                    }`}
                  >
                      ...
                      ? (
                        <>
                          <div class="relative p-8 lg:p-12 flex flex-col justify-center">
                            <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue via-mauve to-blue"></div>
                              ...
                              <div class="flex items-center gap-3 text-subtext1">
                                {post.iconUrl && (
                                  <div class="relative">
                                    ...
                                    />
                                    <div class="absolute inset-0 rounded-full bg-gradient-to-br from-blue/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                  </div>
                                )}
                                {!post.iconUrl && <span class="text-2xl">👤</span>}
                                <div>
                                  {post.authorUrl
                                    ? (
                                      <a
                                  ...
                                  <div class="text-sm text-subtext0">Article Author</div>
                                </div>
                              </div>
                          ...
                          <div class="relative bg-gradient-to-br from-blue/10 via-mauve/10 to-blue/10 p-8 lg:p-12 flex items-center justify-center min-h-[300px] lg:min-h-full">
                            <div class="text-8xl lg:text-9xl opacity-20 group-hover:opacity-30 group-hover:scale-110 transition-all duration-500">📝</div>
                            <div class="absolute inset-0 bg-gradient-to-br from-transparent via-blue/5 to-mauve/5"></div>
                          </div>
                        </>
                      )
                      : (
            ...
            : (
              ...
              <div class="text-center py-32">
                <div class="relative mb-8">
                  ...
                  <div class="absolute inset-0 bg-gradient-to-br from-blue/5 to-mauve/5 rounded-full blur-3xl"></div>
                </div>
